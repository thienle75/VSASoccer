...
cp /var/www/php-engage-soccer/site.conf /etc/apache2/sites-available/soccer.conf
ln -s /etc/apache2/sites-available/soccer.conf /etc/apache2/sites-enabled/soccer.confcd /a
...
mysql -uroot -pwar0662 -e "CREATE DATABASE soccer CHARSET utf8 COLLATE utf8_unicode_ci;"

# add permissions to rawdev, rawdev2, rawdev3 for the tdrewards tables #
mysql -uroot -pwar0662 -e "GRANT ALL PRIVILEGES ON soccer.* TO 'rawdev'@'localhost';"
